...
if (is_admin()) {
    function cf7sr_add_action_links($links) {
        ...
        array_unshift($links , '<a target="captcha" style="font-weight: 900; color: #d54e21;" href="http://wpdb.ro/captcha">Upgrade To Pro</a>');
        return $links;
    }
    ...
    function cf7sr_adminhtml() {
        ...
        <div class="cf7sr-wrap" style="font-size: 15px; background: #fff; border: 1px solid #e5e5e5; margin-top: 20px; padding: 20px; margin-right: 20px;">
            <ul>
                <li><a target="captcha" style="font-weight: 900; color: #d54e21;" href="http://wpdb.ro/captcha">CLICK HERE</a> to upgrade to Pro Version and get: <br></li>
