...
class Frame_Factory {
   ...
   */
  static function decorate_root(DP_Frame $root, DOMPDF $dompdf) {
   ...
   */
  static function decorate_frame(DP_Frame $frame, DOMPDF $dompdf, DP_Frame $root = null) {
    if ( is_null($dompdf) ) {
