...
class Page_Frame_Decorator extends Frame_Decorator {
   ...
   *
   * @param DP_Frame $frame the frame to check
   * @return bool true if a page break occured
   */
  function check_forced_page_break(DP_Frame $frame) {
   ...
   */
  protected function _page_break_allowed(DP_Frame $frame) {
   ...
   */
  function check_page_break(DP_Frame $frame) {
  ...
  function split(DP_Frame $frame = null, $force_pagebreak = false) {
    // Do nothing
  }
   ...
   *
   * @param DP_Frame $frame
   *
   * @return void
   */
  function add_floating_frame(DP_Frame $frame) {
  ...
  public function get_lowest_float_offset(DP_Frame $child) {
