...
function vsrru() 
{
	...
	if ( ! empty($vsrru_data) ) 
	{
		...
		foreach ( $vsrru_data as $vsrru_data ) 
		{
			...
			$vsrruhtml = $vsrruhtml . "<div class='vsrru_div' style='height:50px;padding:1px 0px 1px 0px;'>"; 
			...
			$vsrru_x = $vsrru_x . "vsrru[$vsrru_count] = '<div class=\'vsrru_div\' style=\'height:50px;padding:1px 0px 1px 0px;\'><span class=\'vsrru-regimage\'>$avatar</span><span style=\'padding-left:4px;\'><strong>$vsrru_name.</strong></span><br><span style=\'padding-left:4px;font-size:9px;\'><i>$vsrru_date</i></span></div>'; ";	
			$vsrru_count++;
		}
		...
		<script type="text/javascript" src="<?php echo plugins_url(); ?>/vertical-scroll-recent-registered-user/vertical-scroll-recent-registered-user.js"></script>
