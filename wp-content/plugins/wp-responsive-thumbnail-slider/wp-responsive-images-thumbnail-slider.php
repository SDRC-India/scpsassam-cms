...
<div id="poststuff" > 
   <div id="post-body" class="metabox-holder columns-2" >  
      ...
      <div id="postbox-container-1" class="postbox-container" > 
            ...
            <div class="postbox"> 
                <h3 class="hndle"><span></span>WordPress SEO Breeze Plugin</h3> 

                <div class="inside">
                     <center><a href="http://www.shareasale.com/m-pr.cfm?merchantID=25608&userID=675922&productID=536585574" target="_blank"><img src="<?php echo plugins_url( 'images/SEO-247x180.png', __FILE__ );?>" width="" height="" border="0"></a></center>
                    <div style="margin:10px 5px">
                    </div>
                </div></div>
