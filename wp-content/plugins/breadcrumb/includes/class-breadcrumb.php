		...
		public function breadcrumb_get_page_childs()
			{
				...
				$html.= '<li><span class="separator">'.$breadcrumb_separator.'</span><span title="'.get_the_title().'" >'.breadcrumb_shorten_string(get_the_title(),$breadcrumb_word_char, $breadcrumb_word_char_count, $breadcrumb_word_char_end).'</span></li>';
