 		 	...
 		 	<?php
				...
				{ ?>
	 		 		<style type="text/css">
	 		 			...
	 		 			{
	 		 				width:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02;?>px;
					...
					<div class="portfolio portfolio<?php echo $Total_Soft_Portfolio;?> portfolio_<?php echo $Total_Soft_Portfolio;?>">
						<input type="text" style="display:none;" class="TotalSoftPortfolio_IW<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02;?>">
						...
						<input type="text" style="display:none;" class="portImWidth<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02;?>">
						...
						<div class="gallery gallery<?php echo $Total_Soft_Portfolio;?>">
							<div class="inside">
								<?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){
										$TSoftPort_ElGrid_Images=$wpdb->get_results($wpdb->prepare("SELECT * FROM $table_name6 WHERE TotalSoftPortfolio_IA=%s and Portfolio_ID=%s", $TotalSoftPortfolioAlbums[$i]->TotalSoftPortfolio_ATitle, $Total_Soft_Portfolio));
				            		?>
									<div class="item">
	 			...
	 			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Elastic Grid'){	?>
 					<style type="text/css">
						...
						.og-grid<?php echo $Total_Soft_Portfolio; ?> li { display: inline-block; margin: 10px 5px 0 5px !important;	vertical-align: top; padding: 0 !important; }
						...
						{
							.elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper { max-width: 300px; }
						}
					...
					<script type="text/javascript">
					    jQuery(function(){
					        jQuery("#elastic_grid_demo<?php echo $Total_Soft_Portfolio; ?>").elastic_grid<?php echo $Total_Soft_Portfolio; ?>({
					            ...
					            'filterEffect<?php echo $Total_Soft_Portfolio; ?>': '<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_03;?>', // moveup, scaleup, fallperspective, fly, flip, helix , popup
	 			...
	 			<?php }else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Filterable Grid'){ ?>
 					<style type="text/css">
	 					...
	 					<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19 == "Effect 1" || $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19 == "#ffffff" || $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19 == ""){ ?>
							...
							.filter__item<?php echo $Total_Soft_Portfolio; ?>:hover, .filter__item<?php echo $Total_Soft_Portfolio; ?>:active, .filter__item<?php echo $Total_Soft_Portfolio; ?>:focus 
							{
	 					...
	 					<?php } elseif($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19 == "Effect 3") { ?>
							...
							{
								from { top: 30%; }
								to { top: calc(100% - 30% - 10px); }
							}
							@-webkit-keyframes bounce-bubbles2 
							{
							  	from { top: 18%; }
							  	to { top: 32%; }
							}
	 					...
	 					<?php } elseif($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19 == "Effect 5") { ?>
		 					...
		 					.filter__item<?php echo $Total_Soft_Portfolio; ?>--selected .tot_hov_span 
		 					{
								color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08;?> !important;
								top: -20px;
							    color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08;?>;
							    background-color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_07;?> !important;
						...
						{ 
							...
							left:0;
							bottom:6px;
							background:<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_34;?>;
							text-align:center;
							line-height:1 !important;
							font-size:0px;
							font-weight:400;
						...
						<script>
							...
							function carPop<?php echo $Total_Soft_Portfolio; ?>(cl,number,srcc)
							{
								...
								jQuery('.meta__title<?php echo $Total_Soft_Portfolio; ?>').each(function(){
									if(jQuery(this).attr('name')==cl){
				...
				<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Gallery Portfolio/Content Popup'){ ?>
							...
							jQuery(document).ready(function($){							
								...
								if (jQuery().quicksand) 
								{
									...
									$('.totalsoft-portfolio-categ<?php echo $Total_Soft_Portfolio; ?> li').click(function(e) {
										...
										if (filterClass == 'all') {
											var $filteredData = $data.find('.totalsoft-portfolio-item2<?php echo $Total_Soft_Portfolio; ?>');
										} else {
											var $filteredData = $data.find('.totalsoft-portfolio-item2<?php echo $Total_Soft_Portfolio; ?>[data-type=' + filterClass + ']');
										}
		 			...
		 			<div class="totalsoft-TS_Portfolio_GAA_" >
					   	<div class="totalsoft-portfolio-content">	
							...
							<ul class="totalsoft-portfolio-area<?php echo $Total_Soft_Portfolio; ?>" style='padding:0px;margin:0px;text-align:center;'>	
								<?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){
				            		$TSoftPort_ContPop_Images=$wpdb->get_results($wpdb->prepare("SELECT * FROM $table_name6 WHERE TotalSoftPortfolio_IA=%s and Portfolio_ID=%s", $TotalSoftPortfolioAlbums[$i]->TotalSoftPortfolio_ATitle, $Total_Soft_Portfolio));
					...
					<script>
						...
						jQuery('.totalsoft-portfolio-item2<?php echo $Total_Soft_Portfolio; ?>').click(function(){
				...
				<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Slider Portfolio'){ ?>
				    ...
				    <style type="text/css">
						...
						.jgallery[data-jgallery-id="1"] .jgallery-thumbnails-horizontal { height:50px !important; }
						<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_35=='image'){ ?>
							.jgallery[data-jgallery-id="1"] .jgallery-thumbnails a { height:100% !important; width:auto !important;	}							
							.jgallery[data-jgallery-id="1"] .jgallery-thumbnails a { width:auto !important; height:100% !important; }
						<?php } ?>
						...
						<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='left'){ ?>
							...
							.jgallery[data-jgallery-id="1"] .jgallery-thumbnails-vertical { width:40px !important; }
						<?php } ?>
				...
				<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Gallery Album Animation'){ ?>
					<style type="text/css">
						...
						.TS_Portfolio_GAA_inner<?php echo $Total_Soft_Portfolio;?>-content-image:hover { border: none !important; box-shadow: none !important; margin: 0 !important; padding: 0 !important; }
						...
						<script type="text/javascript">
							jQuery(window).load(function () {
								...
								jQuery('html').click(function() {
									jQuery('#TS_Portfolio_GAA_inner<?php echo $Total_Soft_Portfolio;?>-selection-button-dropdown').fadeOut(250);
								});
								...
								open_close_gallery();
								jQuery('#TS_Portfolio_GAA_fullscreen<?php echo $Total_Soft_Portfolio;?>-inner-right').click(function() {
								 	next_slide();
								});	
								jQuery('#TS_Portfolio_GAA_fullscreen<?php echo $Total_Soft_Portfolio;?>-inner-left').click(function() {
								 	previous_slide();
								});	
							});
						</script>
				...
				<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Portfolio / Hover Effects'){ ?>
					...
					<style type="text/css">
						...
						.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover, .filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked{
							color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_11;?>;
						}
						<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_09 == 'effect01'){ ?>
							...
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover:before,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover:after,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked:before,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked:after
							{
								width: 100%;
							}
						...
						<?php }else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_09 == 'effect11'){ ?>
							...
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked > span::before,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked > span::after,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked::before,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked::after, 
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover > span::before,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover > span::after,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover::before,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover::after 
							{
								-webkit-transform: scale3d(1, 1, 1);
						...
						<?php }else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_09 == 'effect14'){ ?>
							...
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button.is-checked > span,
							.filters-button-group_<?php echo $Total_Soft_Portfolio;?> > button:hover > span 
							{
						...
						<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_17 == 'effect01'){ ?>
							...
							{
							    .TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article:after { border-width: 500px 500px 0 500px; }
							}
							@media screen and (max-width: 1024px)
							{
								.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article .icon li span { font-size: 20px;	}
							}
							@media screen and (max-width: 800px)
							{
								.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article .icon li span { font-size: 25px; }
							}
							@media screen and (max-width: 500px)
							{
								.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article .icon li span { font-size: 35px;	}
							}
						...
						<?php }else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_17 == 'effect03'){ ?>
							...
							@media screen and (max-width: 1024px)
							{
								...
								.TSPortfolioHE_3 article .title { padding: 2px 0; }
							}
							@media screen and (max-width: 800px)
							{
								...
								.TSPortfolioHE_3 article .title { padding: 5px 0; }
							}
							@media screen and (max-width: 500px)
							{
								...
								.TSPortfolioHE_3 article .title { padding: 7px 0; }
							}
							.TSPortfolioHE_Popup_<?php echo $Total_Soft_Portfolio;?>
							{
								border: 1px solid <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_30;?>;
						...
						<?php }else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_17 == 'effect07'){ ?>
							...
							@media only screen and (max-width:767px)
							{
							    .TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article:after { border-width: 800px 800px 800px 0; }
							}
						<?php }else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_17 == 'effect08'){ ?>
							...
							.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article:hover .box-content:before,
							.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article:hover .box-content:after
							{
							    opacity: 1;
							    transform: scale(1);
							}
						...
						.TSPortfolioHE_Ov_Div_<?php echo $Total_Soft_Portfolio;?> .TSPortfolioHE_Ov_Div4:hover span:before,
						.TSPortfolioHE_Ov_Div_<?php echo $Total_Soft_Portfolio;?> .TSPortfolioHE_Ov_Div4:hover span:after
						{
						  	background:<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_11;?>;
						}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spana 
						{
						   	0% {height: 3px;}
						  	20% {height: 10px;}
						  	40% {height: 20px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spana_a 
						{
						   	0% {height: 2px;}
						  	20% {height: 10px;}
						  	40% {height: 20px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spana_b 
						{
						   	0% {height: 2px;}
						  	20% {height: 7px;}
						  	40% {height: 12px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spana_c 
						{
						   	0% {height: 2px;}
						  	20% {height: 5px;}
						  	40% {height: 10px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spanb 
						{
						   	0% {width: 3px;}
						  	20% {width: 10px;}
						  	40% {width: 20px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spanb_a 
						{
						   	0% {width: 2px;}
						  	20% {width: 10px;}
						  	40% {width: 20px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spanb_b 
						{
						   	0% {width: 2px;}
						  	20% {width: 7px;}
						  	40% {width: 12px;}
						...
						@-webkit-keyframes TSPortfolioHE_Ov_Spanb_c 
						{
						   	0% {width: 2px;}
						  	20% {width: 5px;}
						  	40% {width: 10px;}
						...
						{
						  	.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article { width: 31.3%; }
						}
						@media (max-width: 800px) 
						{
						  	.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article { width: 48%; }
						}
						@media (max-width: 500px) {
							.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?> article { width: 100%; margin: 2% 0;	}						  	
						}
					</style>					
					<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02 == 'true'){ ?>
						<div class="button-group filters-button-group filters-button-group_<?php echo $Total_Soft_Portfolio;?>">
							<div></div>
						    <button class="button is-checked TSPortfolioHE_Button_<?php echo $Total_Soft_Portfolio;?>" data-filter="*"><span><?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_01;?></span></button>
						    <?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){ ?>
						   		<button class="button TSPortfolioHE_Button_<?php echo $Total_Soft_Portfolio;?>" data-filter=".<?php echo str_replace(" ","_", $TotalSoftPortfolioAlbums[$i]->TotalSoftPortfolio_ATitle) . $Total_Soft_Portfolio;?>"><span><?php echo $TotalSoftPortfolioAlbums[$i]->TotalSoftPortfolio_ATitle;?></span></button>
						    <?php }?>
						</div>
					<?php }?>
					...
					<div class="TSPortfolioHE_Ov_Div_<?php echo $Total_Soft_Portfolio;?>">
						<?php for($i=0;$i<count($TotalSoftPortfolioImages);$i++){ 
							if($i == 0)
							{
								$prevImage = count($TotalSoftPortfolioImages);
							}
							else
							{
								$prevImage = $i;
							}
							if($i == count($TotalSoftPortfolioImages)-1)
							{
								$nextImage = 1;
							}
							else
					...
					<script type="text/javascript">
						jQuery( function() {
							var $grid = jQuery('.TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?>').isotope({
