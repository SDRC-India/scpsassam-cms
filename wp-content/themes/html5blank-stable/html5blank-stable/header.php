  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="50">
    ...
    <div class="container-fluid header_bg">
      <div class="container">
        <div class="col-md-12" >
          <div class="col-md-6 col-sm-6">
            <div class="logo_holder"> <a href="#"><img src="assets/img/scps_logo.png" alt="SCPS Bihar"  /></a>
              <h2>State Child Protection Society</h2>
              <h3>Ministry of Women and Child Development</h3>
              <h3>Government Of Bihar</h3>
            </div>
          </div>
          <div class="col-md-6 col-sm-6"><img src="assets/img/bihar_logo_red.jpg" alt="SCPS Bihar" style= "height:100px;width:91px;float:right;margin-top:10px;" /></div>
        </div>
      </div>
    </div>
    <!-- logo row ends -->
