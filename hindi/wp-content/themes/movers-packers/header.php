...
<?php } ?>
  ...
  <div class="header <?php if ( !is_front_page() && ! is_home() ) { ?>innerheader<?php } ?>">
        <div class="container">
			...
			<a href="#"><img class="logoresp" src="http://scpsbihar.org/hindi/wp-content/uploads/2016/12/scps_logo-e1480587026510.png" alt="SCPS Bihar"></a>
                        <h1 class="logohead1">State Child Protection Society</h1>
                        <h3 class="logohead2">Directorate of Social Welfare Department, Govt. of Assam</h3>
			<!--<h3 class="logohead3"> Government Of Bihar</h3>-->
            </div>
            ...
            <div class="header_right"> 
             ...
             <?php if ( ! dynamic_sidebar( 'header-info' ) ) : ?>
              ...
              <img  src="http://scpsbihar.org/hindi/wp-content/uploads/2016/11/bihar_logo_red.jpg" alt="SCPS Bihar" style="height:100px;width:124px;float:right;margin-right: 27px;">
...
<div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">
          <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slide-1.jpg" alt="" title="#slidecaption1" />
        <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slide-2.jpg" alt="" title="#slidecaption2" />
        <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slide-3.jpg" alt="" title="#slidecaption3" />
    </div>                                    
...
<div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">
          <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slide-1.jpg" alt="" title="#slidecaption1" />
        <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slide-3.jpg" alt="" title="#slidecaption2" />
        <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slide-3.jpg" alt="" title="#slidecaption3" />
    </div>                                      
  ...
  <section id="wrapfirst">
            	<div class="container">
                    ...
                    <?php while( $queryvar->have_posts() ) : $queryvar->the_post();?> 		
                     ...
                     <div class="clear"></div>
                    <?php endwhile; } else { ?>                    
                    <h3><?php esc_attr_e('About SCPS Bihar','movers-packers'); ?></h3>
...
<div id="pagearea">
  ...
  <div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 four-col-box">
      <div class="ca-hover ">
        <div class="carousel-img"> <img src="http://scpsbihar.org/hindi/wp-content/uploads/2016/12/pix-1.jpg" alt="Objectives" class="img-responsive"> </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 four-col-box">
      <div class="ca-hover">
        <div class="carousel-img"> <img src="http://scpsbihar.org/hindi/wp-content/uploads/2016/11/pix-2.jpg" alt="Achievements" class="img-responsive"> </div>
        <div class="carousel-content">
          <h3>Achievements</h3>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. <br>
            <br>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 four-col-box">
      <div class="ca-hover">
        <div class="carousel-img"> <img src="http://scpsbihar.org/hindi/wp-content/uploads/2016/11/pix-3.jpg" alt="Projects" class="img-responsive"> </div>
        <div class="carousel-content">
          <h3>Projects</h3>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. <br>
            <br>
